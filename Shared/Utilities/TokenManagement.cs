...
namespace Verdant.Zero.Erp.Api.Shared.Utilities
{
    public static class TokenManagement
    {
        ...
        {
            var sharedKey = new SymmetricSecurityKey(Encoding.UTF8.GetBytes("Verdant.Zero.Erp.Api.Shared.Utilities.TokenManagement"));
